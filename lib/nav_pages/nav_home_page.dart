...
class NavHomePage1 extends StatefulWidget{
  @override
  State<StatefulWidget> createState() => _NavHomePage();
}

class _NavHomePage extends State<NavHomePage1>{
  ...
  Future<void> getAllNotes()async{
    ...
    progress = (progress/DbList.allTask.length*100).roundToDouble();
    setState(() {
              ...
              child: Container(
                ...
                child: Padding(
                    ...
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Today's progress summery",style: TextStyle(color: Colors.white,fontSize: 23),),
                        /*-------Task Added-------*/
                        Text("${DbList.allTask.length} Tasks",style: TextStyle(color: Colors.white,fontSize: 16),),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                          children: [
                            Column(
                                ...
                                Stack(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                          border: Border(top: BorderSide(color: Colors.white,width: 7)),
                                          borderRadius: BorderRadius.circular(8)
                                      ),
                                    ),
                                  ],
                            ...
                            children: [
                              InkWell(
                                ...
                                onTap:(){
                                  ...
                                  child:DbList.allTask[Index].isCompleted == 0  ?
                    ...
                    Row(
                      ...
                      children: [
                        OutlinedButton(
                            onPressed: (){
                              addOneTask();
                              updateIsCompleted(s_no: DbList.allTask.length+1, isCompleted: 0);
